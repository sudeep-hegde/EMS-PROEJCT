...
public class EmployeeController {
    ...
    public ResponseEntity<Employee> updateEmployee(@PathVariable long id,@RequestBody Employee employeeDetails) {
        ...
        updateEmployee.setPhno(employeeDetails.getPhno());
    ...
    public ResponseEntity<List<Employee>> searchEmployees(@RequestParam("name") String name) {
        List<Employee> results = employeeRepository.searchEmployees(name.toLowerCase()); // Convert the input to lowercase
